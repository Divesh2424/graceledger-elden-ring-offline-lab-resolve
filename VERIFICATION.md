# Verification plan — ELDEN RING

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. Offline build scenarios

- [ ] Define a versioned input fixture specifically for offline build scenarios.
...
### 2. Equipment comparison sheets

- [ ] Define a versioned input fixture specifically for equipment comparison sheets.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Save restore verification

- [ ] Define a versioned input fixture specifically for save restore verification.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
