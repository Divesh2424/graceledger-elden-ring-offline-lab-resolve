...
- **离线配装场景** (Offline build scenarios) — 规划模块，尚未实现。
- **装备比较表** (Equipment comparison sheets) — 规划模块，尚未实现。
- **存档恢复验证** (Save restore verification) — 规划模块，尚未实现。
