...
<div align="center">
  <img src="./public/logo.svg" alt="GraceLedger — ELDEN RING — Resolve" width="64" height="64">
  <h1>GraceLedger — ELDEN RING — Resolve</h1>
</div>

An independent project specification for ELDEN RING, covering offline build scenarios, equipment comparison sheets, save restore verification.
...
<img src="./public/screenshots/desktop-main.svg" alt="ELDEN RING — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="ELDEN RING — compact concept, not a screenshot" width="250">
<br>
...
- **Offline build scenarios** — planned module; not implemented.
- **Equipment comparison sheets** — planned module; not implemented.
- **Save restore verification** — planned module; not implemented.

The proposed workflow separates offline build scenarios from equipment comparison sheets, with save restore verification retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Offline build scenarios**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="GraceLedger — ELDEN RING — Resolve — specification review workflow">
<br>
...
### Offline build scenarios

Define the input and expected outcome for module 1. Record the ELDEN RING version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Equipment comparison sheets

Define the input and expected outcome for module 2. Record the ELDEN RING version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Save restore verification

Define the input and expected outcome for module 3. Record the ELDEN RING version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Offline build scenarios |
